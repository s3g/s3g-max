...
struct t_s3g_dbappan {
    t_pxobject object;
    DbapPanImpl* impl = nullptr;
...
t_class* s_s3g_dbappan_class = nullptr;

void notify_attr(t_s3g_dbappan* x, const char* name)
{
    if (!x || !name) return;
    object_attr_touch(reinterpret_cast<t_object*>(x), gensym(name));
}

void notify_selected_source_attrs(t_s3g_dbappan* x)
{
...
void s3g_dbappan_perform64(t_s3g_dbappan* x,
                             t_object*,
                             double** ins,
                             long numins,
                             double** outs,
                             ...
                             long,
                             void*);
void s3g_dbappan_dump(t_s3g_dbappan* x);
...
{
    return method == s3g::LayoutPannerMethod::Dbap ? "dbap" : (method == s3g::LayoutPannerMethod::Cosine ? "cos" : "dist");
}
...
void sync_attrs(t_s3g_dbappan* x)
{
    if (!x || !x->impl) return;
...
void apply_params(t_s3g_dbappan* x)
{
    if (!x || !x->impl) return;
    x->impl->params.method = s3g::LayoutPannerMethod::Dbap;
    x->impl->panner.setParams(x->impl->params);
    sync_attrs(x);
    s3g_dbappan_dump(x);
}

void prepare(t_s3g_dbappan* x, double sampleRate)
{
    if (!x || !x->impl) return;
...
void set_layout(t_s3g_dbappan* x, s3g::LayoutPannerPreset preset)
{
...
void set_method(t_s3g_dbappan* x, s3g::LayoutPannerMethod method)
{
...
void set_focus(t_s3g_dbappan* x, double v) { x->impl->params.focus = static_cast<float>(v); apply_params(x); notify_attr(x, "focus"); }
void set_rolloff(t_s3g_dbappan* x, double v) { x->impl->params.distanceRolloffDb = static_cast<float>(v); apply_params(x); notify_attr(x, "rolloff"); }
void set_smooth(t_s3g_dbappan* x, double v) { x->impl->params.smoothingMs = static_cast<float>(v); apply_params(x); notify_attr(x, "smooth"); }
void set_globalaz(t_s3g_dbappan* x, double v) { x->impl->params.globalAzimuthDeg = static_cast<float>(v); apply_params(x); notify_attr(x, "globalaz"); }
void set_globalel(t_s3g_dbappan* x, double v) { x->impl->params.globalElevationDeg = static_cast<float>(v); apply_params(x); notify_attr(x, "globalel"); }
void set_globaldist(t_s3g_dbappan* x, double v) { x->impl->params.globalDistanceOffset = static_cast<float>(v); apply_params(x); notify_attr(x, "globaldist"); }
void set_diffusion(t_s3g_dbappan* x, double v) { x->impl->params.distanceDiffusion = static_cast<float>(v); apply_params(x); notify_attr(x, "diffusion"); }
void set_inside(t_s3g_dbappan* x, double v) { x->impl->params.insideMode = static_cast<s3g::LayoutPannerInsideMode>(std::clamp<long>(static_cast<long>(std::lround(v)), 0, 3)); apply_params(x); notify_attr(x, "inside"); }
void set_output(t_s3g_dbappan* x, double v) { x->impl->params.outputGainDb = static_cast<float>(v); apply_params(x); notify_attr(x, "output"); }

void set_selected(t_s3g_dbappan* x, double v)
{
...
void set_selected_source_aed(t_s3g_dbappan* x, double az, double el, double dist, double gain)
{
...
void s3g_dbappan_layout(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
...
void s3g_dbappan_method(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 1 || !argv) return;
...
void s3g_dbappan_focus(t_s3g_dbappan* x, double v) { set_focus(x, v); }
void s3g_dbappan_rolloff(t_s3g_dbappan* x, double v) { set_rolloff(x, v); }
void s3g_dbappan_smooth(t_s3g_dbappan* x, double v) { set_smooth(x, v); }
void s3g_dbappan_globalaz(t_s3g_dbappan* x, double v) { set_globalaz(x, v); }
void s3g_dbappan_globalel(t_s3g_dbappan* x, double v) { set_globalel(x, v); }
void s3g_dbappan_globaldist(t_s3g_dbappan* x, double v) { set_globaldist(x, v); }
void s3g_dbappan_diffusion(t_s3g_dbappan* x, double v) { set_diffusion(x, v); }
void s3g_dbappan_inside(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 1 || !argv) return;
    if (atom_gettype(argv) == A_SYM) {
...
void s3g_dbappan_output(t_s3g_dbappan* x, double v) { set_output(x, v); }
void s3g_dbappan_select(t_s3g_dbappan* x, double v) { set_selected(x, v); }
void s3g_dbappan_azimuth(t_s3g_dbappan* x, double v) { set_selected_source_aed(x, v, x->elevation, x->distance, x->sourcegain); }
void s3g_dbappan_elevation(t_s3g_dbappan* x, double v) { set_selected_source_aed(x, x->azimuth, v, x->distance, x->sourcegain); }
void s3g_dbappan_distance(t_s3g_dbappan* x, double v) { set_selected_source_aed(x, x->azimuth, x->elevation, v, x->sourcegain); }
void s3g_dbappan_sourcegain(t_s3g_dbappan* x, double v) { set_selected_source_aed(x, x->azimuth, x->elevation, x->distance, v); }

void s3g_dbappan_source(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 4) {
...
void s3g_dbappan_sourcexyz(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 4) {
...
void s3g_dbappan_sourcegain_msg(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
...
void s3g_dbappan_mute(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 2) return;
...
void s3g_dbappan_solo(t_s3g_dbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 2) return;
...
t_max_err attr_layout_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv)
{
...
t_max_err attr_method_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 1 || !argv) return MAX_ERR_NONE;
    if (atom_gettype(argv) == A_SYM) {
...
t_max_err attr_focus_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_focus(x, atom_double_at(argc, argv, 0, x->focus)); return MAX_ERR_NONE; }
t_max_err attr_rolloff_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_rolloff(x, atom_double_at(argc, argv, 0, x->rolloff)); return MAX_ERR_NONE; }
t_max_err attr_smooth_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_smooth(x, atom_double_at(argc, argv, 0, x->smooth)); return MAX_ERR_NONE; }
t_max_err attr_globalaz_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_globalaz(x, atom_double_at(argc, argv, 0, x->globalaz)); return MAX_ERR_NONE; }
t_max_err attr_globalel_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_globalel(x, atom_double_at(argc, argv, 0, x->globalel)); return MAX_ERR_NONE; }
t_max_err attr_globaldist_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_globaldist(x, atom_double_at(argc, argv, 0, x->globaldist)); return MAX_ERR_NONE; }
t_max_err attr_diffusion_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_diffusion(x, atom_double_at(argc, argv, 0, x->diffusion)); return MAX_ERR_NONE; }
t_max_err attr_inside_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_inside(x, atom_double_at(argc, argv, 0, x->inside)); return MAX_ERR_NONE; }
t_max_err attr_output_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_output(x, atom_double_at(argc, argv, 0, x->output)); return MAX_ERR_NONE; }
t_max_err attr_selected_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { set_selected(x, atom_double_at(argc, argv, 0, x->selected)); return MAX_ERR_NONE; }
t_max_err attr_azimuth_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { s3g_dbappan_azimuth(x, atom_double_at(argc, argv, 0, x->azimuth)); return MAX_ERR_NONE; }
t_max_err attr_elevation_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { s3g_dbappan_elevation(x, atom_double_at(argc, argv, 0, x->elevation)); return MAX_ERR_NONE; }
t_max_err attr_distance_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { s3g_dbappan_distance(x, atom_double_at(argc, argv, 0, x->distance)); return MAX_ERR_NONE; }
t_max_err attr_sourcegain_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv) { s3g_dbappan_sourcegain(x, atom_double_at(argc, argv, 0, x->sourcegain)); return MAX_ERR_NONE; }

t_max_err attr_mc_set(t_s3g_dbappan* x, void*, long argc, t_atom* argv)
{
...
void s3g_dbappan_dsp64(t_s3g_dbappan* x, t_object* dsp64, short*, double sampleRate, long, long)
{
    if (!x->impl->prepared || sampleRate != x->impl->sampleRate) {
        prepare(x, sampleRate);
    }
    object_method(dsp64, gensym("dsp_add64"), x, s3g_dbappan_perform64, 0, nullptr);
}

void s3g_dbappan_perform64(t_s3g_dbappan* x, t_object*, double** ins, long numins, double** outs, long numouts, long sampleframes, long, void*)
{
    if (!x || !x->impl) return;
    if (!x->impl->prepared) {
...
void s3g_dbappan_assist(t_s3g_dbappan* x, void*, long message, long index, char* text)
{
...
long s3g_dbappan_multichanneloutputs(t_s3g_dbappan* x, long index)
{
    if (!x || !x->mc || index != 0 || !x->impl) return 0;
    return x->impl->outputCount;
}

long s3g_dbappan_inputchanged(t_s3g_dbappan* x, long, long)
{
    (void)x;
    return false;
}

void* s3g_dbappan_new(t_symbol*, long argc, t_atom* argv)
{
    auto* x = static_cast<t_s3g_dbappan*>(object_alloc(s_s3g_dbappan_class));
    if (!x) return nullptr;

    x->impl = new DbapPanImpl();
...
void s3g_dbappan_free(t_s3g_dbappan* x)
{
...
{
    t_class* c = class_new("s3g.dbappan~",
                           reinterpret_cast<method>(s3g_dbappan_new),
                           reinterpret_cast<method>(s3g_dbappan_free),
                           sizeof(t_s3g_dbappan),
                           nullptr,
                           A_GIMME,
                           0);

    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_dsp64), "dsp64", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_assist), "assist", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_multichanneloutputs), "multichanneloutputs", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_inputchanged), "inputchanged", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_layout), "layout", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_focus), "focus", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_rolloff), "rolloff", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_smooth), "smooth", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_globalaz), "globalaz", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_globalel), "globalel", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_globaldist), "globaldist", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_diffusion), "diffusion", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_inside), "inside", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_output), "output", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_select), "select", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_select), "selected", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_azimuth), "azimuth", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_elevation), "elevation", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_distance), "distance", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_sourcegain), "sourcegain", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_source), "source", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_sourcexyz), "sourcexyz", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_sourcegain_msg), "srcgain", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_mute), "mute", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_solo), "solo", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_dbappan_dump), "dump", 0);

    CLASS_ATTR_DOUBLE(c, "layout", 0, t_s3g_dbappan, layout);
    ...
    CLASS_ATTR_DOUBLE(c, "focus", 0, t_s3g_dbappan, focus);
    ...
    CLASS_ATTR_DOUBLE(c, "rolloff", 0, t_s3g_dbappan, rolloff);
    ...
    CLASS_ATTR_DOUBLE(c, "smooth", 0, t_s3g_dbappan, smooth);
    ...
    CLASS_ATTR_DOUBLE(c, "globalaz", 0, t_s3g_dbappan, globalaz);
    ...
    CLASS_ATTR_DOUBLE(c, "globalel", 0, t_s3g_dbappan, globalel);
    ...
    CLASS_ATTR_DOUBLE(c, "globaldist", 0, t_s3g_dbappan, globaldist);
    ...
    CLASS_ATTR_DOUBLE(c, "diffusion", 0, t_s3g_dbappan, diffusion);
    ...
    CLASS_ATTR_DOUBLE(c, "inside", 0, t_s3g_dbappan, inside);
    ...
    CLASS_ATTR_DOUBLE(c, "output", 0, t_s3g_dbappan, output);
    ...
    CLASS_ATTR_DOUBLE(c, "selected", 0, t_s3g_dbappan, selected);
    ...
    CLASS_ATTR_DOUBLE(c, "azimuth", 0, t_s3g_dbappan, azimuth);
    ...
    CLASS_ATTR_DOUBLE(c, "elevation", 0, t_s3g_dbappan, elevation);
    ...
    CLASS_ATTR_DOUBLE(c, "distance", 0, t_s3g_dbappan, distance);
    ...
    CLASS_ATTR_DOUBLE(c, "sourcegain", 0, t_s3g_dbappan, sourcegain);
    ...
    CLASS_ATTR_LONG(c, "mc", 0, t_s3g_dbappan, mc);
    ...
    s_s3g_dbappan_class = c;
    post("s3g.dbappan~: wrapping s3g::LayoutPanner from s3g-dsp");
    (void)r;
}
