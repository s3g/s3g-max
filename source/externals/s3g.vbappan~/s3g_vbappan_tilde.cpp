...
struct t_s3g_vbappan {
    t_pxobject object;
    VbapPanImpl* impl = nullptr;
...
t_class* s_s3g_vbappan_class = nullptr;

void notify_attr(t_s3g_vbappan* x, const char* name)
{
    if (!x || !name) return;
    object_attr_touch(reinterpret_cast<t_object*>(x), gensym(name));
}

void notify_selected_source_attrs(t_s3g_vbappan* x)
{
...
void s3g_vbappan_perform64(t_s3g_vbappan* x,
                             t_object*,
                             double** ins,
                             long numins,
                             double** outs,
                             ...
                             long,
                             void*);
void s3g_vbappan_dump(t_s3g_vbappan* x);
...
{
    return method == s3g::LayoutPannerMethod::Vbap ? "vbap" : (method == s3g::LayoutPannerMethod::Cosine ? "cos" : "dist");
}
...
void sync_attrs(t_s3g_vbappan* x)
{
    if (!x || !x->impl) return;
...
void apply_params(t_s3g_vbappan* x)
{
    if (!x || !x->impl) return;
    x->impl->params.method = s3g::LayoutPannerMethod::Vbap;
    x->impl->panner.setParams(x->impl->params);
    sync_attrs(x);
    s3g_vbappan_dump(x);
}

void prepare(t_s3g_vbappan* x, double sampleRate)
{
    if (!x || !x->impl) return;
...
void set_layout(t_s3g_vbappan* x, s3g::LayoutPannerPreset preset)
{
...
void set_method(t_s3g_vbappan* x, s3g::LayoutPannerMethod method)
{
...
void set_focus(t_s3g_vbappan* x, double v) { x->impl->params.focus = static_cast<float>(v); apply_params(x); notify_attr(x, "focus"); }
void set_rolloff(t_s3g_vbappan* x, double v) { x->impl->params.distanceRolloffDb = static_cast<float>(v); apply_params(x); notify_attr(x, "rolloff"); }
void set_smooth(t_s3g_vbappan* x, double v) { x->impl->params.smoothingMs = static_cast<float>(v); apply_params(x); notify_attr(x, "smooth"); }
void set_globalaz(t_s3g_vbappan* x, double v) { x->impl->params.globalAzimuthDeg = static_cast<float>(v); apply_params(x); notify_attr(x, "globalaz"); }
void set_globalel(t_s3g_vbappan* x, double v) { x->impl->params.globalElevationDeg = static_cast<float>(v); apply_params(x); notify_attr(x, "globalel"); }
void set_globaldist(t_s3g_vbappan* x, double v) { x->impl->params.globalDistanceOffset = static_cast<float>(v); apply_params(x); notify_attr(x, "globaldist"); }
void set_diffusion(t_s3g_vbappan* x, double v) { x->impl->params.distanceDiffusion = static_cast<float>(v); apply_params(x); notify_attr(x, "diffusion"); }
void set_inside(t_s3g_vbappan* x, double v) { x->impl->params.insideMode = static_cast<s3g::LayoutPannerInsideMode>(std::clamp<long>(static_cast<long>(std::lround(v)), 0, 3)); apply_params(x); notify_attr(x, "inside"); }
void set_output(t_s3g_vbappan* x, double v) { x->impl->params.outputGainDb = static_cast<float>(v); apply_params(x); notify_attr(x, "output"); }

void set_selected(t_s3g_vbappan* x, double v)
{
...
void set_selected_source_aed(t_s3g_vbappan* x, double az, double el, double dist, double gain)
{
...
void s3g_vbappan_layout(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
...
void s3g_vbappan_method(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 1 || !argv) return;
...
void s3g_vbappan_focus(t_s3g_vbappan* x, double v) { set_focus(x, v); }
void s3g_vbappan_rolloff(t_s3g_vbappan* x, double v) { set_rolloff(x, v); }
void s3g_vbappan_smooth(t_s3g_vbappan* x, double v) { set_smooth(x, v); }
void s3g_vbappan_globalaz(t_s3g_vbappan* x, double v) { set_globalaz(x, v); }
void s3g_vbappan_globalel(t_s3g_vbappan* x, double v) { set_globalel(x, v); }
void s3g_vbappan_globaldist(t_s3g_vbappan* x, double v) { set_globaldist(x, v); }
void s3g_vbappan_diffusion(t_s3g_vbappan* x, double v) { set_diffusion(x, v); }
void s3g_vbappan_inside(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 1 || !argv) return;
    if (atom_gettype(argv) == A_SYM) {
...
void s3g_vbappan_output(t_s3g_vbappan* x, double v) { set_output(x, v); }
void s3g_vbappan_select(t_s3g_vbappan* x, double v) { set_selected(x, v); }
void s3g_vbappan_azimuth(t_s3g_vbappan* x, double v) { set_selected_source_aed(x, v, x->elevation, x->distance, x->sourcegain); }
void s3g_vbappan_elevation(t_s3g_vbappan* x, double v) { set_selected_source_aed(x, x->azimuth, v, x->distance, x->sourcegain); }
void s3g_vbappan_distance(t_s3g_vbappan* x, double v) { set_selected_source_aed(x, x->azimuth, x->elevation, v, x->sourcegain); }
void s3g_vbappan_sourcegain(t_s3g_vbappan* x, double v) { set_selected_source_aed(x, x->azimuth, x->elevation, x->distance, v); }

void s3g_vbappan_source(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 4) {
...
void s3g_vbappan_sourcexyz(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 4) {
...
void s3g_vbappan_sourcegain_msg(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
...
void s3g_vbappan_mute(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 2) return;
...
void s3g_vbappan_solo(t_s3g_vbappan* x, t_symbol*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 2) return;
...
t_max_err attr_layout_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv)
{
...
t_max_err attr_method_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv)
{
    if (!x || !x->impl || argc < 1 || !argv) return MAX_ERR_NONE;
    if (atom_gettype(argv) == A_SYM) {
...
t_max_err attr_focus_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_focus(x, atom_double_at(argc, argv, 0, x->focus)); return MAX_ERR_NONE; }
t_max_err attr_rolloff_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_rolloff(x, atom_double_at(argc, argv, 0, x->rolloff)); return MAX_ERR_NONE; }
t_max_err attr_smooth_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_smooth(x, atom_double_at(argc, argv, 0, x->smooth)); return MAX_ERR_NONE; }
t_max_err attr_globalaz_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_globalaz(x, atom_double_at(argc, argv, 0, x->globalaz)); return MAX_ERR_NONE; }
t_max_err attr_globalel_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_globalel(x, atom_double_at(argc, argv, 0, x->globalel)); return MAX_ERR_NONE; }
t_max_err attr_globaldist_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_globaldist(x, atom_double_at(argc, argv, 0, x->globaldist)); return MAX_ERR_NONE; }
t_max_err attr_diffusion_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_diffusion(x, atom_double_at(argc, argv, 0, x->diffusion)); return MAX_ERR_NONE; }
t_max_err attr_inside_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_inside(x, atom_double_at(argc, argv, 0, x->inside)); return MAX_ERR_NONE; }
t_max_err attr_output_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_output(x, atom_double_at(argc, argv, 0, x->output)); return MAX_ERR_NONE; }
t_max_err attr_selected_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { set_selected(x, atom_double_at(argc, argv, 0, x->selected)); return MAX_ERR_NONE; }
t_max_err attr_azimuth_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { s3g_vbappan_azimuth(x, atom_double_at(argc, argv, 0, x->azimuth)); return MAX_ERR_NONE; }
t_max_err attr_elevation_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { s3g_vbappan_elevation(x, atom_double_at(argc, argv, 0, x->elevation)); return MAX_ERR_NONE; }
t_max_err attr_distance_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { s3g_vbappan_distance(x, atom_double_at(argc, argv, 0, x->distance)); return MAX_ERR_NONE; }
t_max_err attr_sourcegain_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv) { s3g_vbappan_sourcegain(x, atom_double_at(argc, argv, 0, x->sourcegain)); return MAX_ERR_NONE; }

t_max_err attr_mc_set(t_s3g_vbappan* x, void*, long argc, t_atom* argv)
{
...
void s3g_vbappan_dsp64(t_s3g_vbappan* x, t_object* dsp64, short*, double sampleRate, long, long)
{
    if (!x->impl->prepared || sampleRate != x->impl->sampleRate) {
        prepare(x, sampleRate);
    }
    object_method(dsp64, gensym("dsp_add64"), x, s3g_vbappan_perform64, 0, nullptr);
}

void s3g_vbappan_perform64(t_s3g_vbappan* x, t_object*, double** ins, long numins, double** outs, long numouts, long sampleframes, long, void*)
{
    if (!x || !x->impl) return;
    if (!x->impl->prepared) {
...
void s3g_vbappan_assist(t_s3g_vbappan* x, void*, long message, long index, char* text)
{
...
long s3g_vbappan_multichanneloutputs(t_s3g_vbappan* x, long index)
{
    if (!x || !x->mc || index != 0 || !x->impl) return 0;
    return x->impl->outputCount;
}

long s3g_vbappan_inputchanged(t_s3g_vbappan* x, long, long)
{
    (void)x;
    return false;
}

void* s3g_vbappan_new(t_symbol*, long argc, t_atom* argv)
{
    auto* x = static_cast<t_s3g_vbappan*>(object_alloc(s_s3g_vbappan_class));
    if (!x) return nullptr;

    x->impl = new VbapPanImpl();
...
void s3g_vbappan_free(t_s3g_vbappan* x)
{
...
{
    t_class* c = class_new("s3g.vbappan~",
                           reinterpret_cast<method>(s3g_vbappan_new),
                           reinterpret_cast<method>(s3g_vbappan_free),
                           sizeof(t_s3g_vbappan),
                           nullptr,
                           A_GIMME,
                           0);

    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_dsp64), "dsp64", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_assist), "assist", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_multichanneloutputs), "multichanneloutputs", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_inputchanged), "inputchanged", A_CANT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_layout), "layout", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_focus), "focus", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_rolloff), "rolloff", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_smooth), "smooth", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_globalaz), "globalaz", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_globalel), "globalel", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_globaldist), "globaldist", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_diffusion), "diffusion", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_inside), "inside", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_output), "output", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_select), "select", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_select), "selected", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_azimuth), "azimuth", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_elevation), "elevation", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_distance), "distance", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_sourcegain), "sourcegain", A_FLOAT, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_source), "source", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_sourcexyz), "sourcexyz", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_sourcegain_msg), "srcgain", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_mute), "mute", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_solo), "solo", A_GIMME, 0);
    class_addmethod(c, reinterpret_cast<method>(s3g_vbappan_dump), "dump", 0);

    CLASS_ATTR_DOUBLE(c, "layout", 0, t_s3g_vbappan, layout);
    ...
    CLASS_ATTR_DOUBLE(c, "focus", 0, t_s3g_vbappan, focus);
    ...
    CLASS_ATTR_DOUBLE(c, "rolloff", 0, t_s3g_vbappan, rolloff);
    ...
    CLASS_ATTR_DOUBLE(c, "smooth", 0, t_s3g_vbappan, smooth);
    ...
    CLASS_ATTR_DOUBLE(c, "globalaz", 0, t_s3g_vbappan, globalaz);
    ...
    CLASS_ATTR_DOUBLE(c, "globalel", 0, t_s3g_vbappan, globalel);
    ...
    CLASS_ATTR_DOUBLE(c, "globaldist", 0, t_s3g_vbappan, globaldist);
    ...
    CLASS_ATTR_DOUBLE(c, "diffusion", 0, t_s3g_vbappan, diffusion);
    ...
    CLASS_ATTR_DOUBLE(c, "inside", 0, t_s3g_vbappan, inside);
    ...
    CLASS_ATTR_DOUBLE(c, "output", 0, t_s3g_vbappan, output);
    ...
    CLASS_ATTR_DOUBLE(c, "selected", 0, t_s3g_vbappan, selected);
    ...
    CLASS_ATTR_DOUBLE(c, "azimuth", 0, t_s3g_vbappan, azimuth);
    ...
    CLASS_ATTR_DOUBLE(c, "elevation", 0, t_s3g_vbappan, elevation);
    ...
    CLASS_ATTR_DOUBLE(c, "distance", 0, t_s3g_vbappan, distance);
    ...
    CLASS_ATTR_DOUBLE(c, "sourcegain", 0, t_s3g_vbappan, sourcegain);
    ...
    CLASS_ATTR_LONG(c, "mc", 0, t_s3g_vbappan, mc);
    ...
    s_s3g_vbappan_class = c;
    post("s3g.vbappan~: wrapping s3g::LayoutPanner from s3g-dsp");
    (void)r;
}
